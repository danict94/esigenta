...
docs/bugs/COMPANY_NOTIFICATION_VISIBILITY_AUDIT.md

docs/bugs/REQUEST_PUBLICATION_DISPATCH_AUDIT.md
...
docs/geo-refoundation/04_CLEANUP_REPORT.md
...
docs/bugs/EMAIL_SYSTEM_RELIABILITY_AUDIT.md
...
docs/catalog-evolution/SEARCH_INTELLIGENCE_AUDIT.md

docs/catalog-evolution/SEARCH_INTELLIGENCE_V2_REVIEW.md
...
scrivere in roadmap_bug.md lo stato di chiusura bug e come sono stati risolti annotare e aggiornare