...
Inputs: `docs/design/HOME_DESIGN_SYSTEM.md`, `docs/LEGACY_UI_DEPENDENCY_MAP.md`, `docs/architecture/LEGACY_UI_DEMOLITION_PLAN.md`, and the Phase 1 deletions already executed against this repo (see "Already done" below).
