    ...
    <>
      ...
      >
        ...
        >
          ...
          <br />
          <b className="font-semibold text-eg-brand-strong">in pochi minuti.</b>
        </h2>
        <p className="mx-auto mt-[18px] max-w-[40ch] text-base leading-[1.6] text-eg-text-muted">
          Verifichiamo P.IVA e requisiti, poi iniziano ad arrivare le richieste.
          Nessun costo per registrarsi.
        </p>
        <Link
          href="#inizia"
          className="eg-button-primary mt-8"
        >
          Crea il profilo professionista <span aria-hidden="true">&rarr;</span>
        </Link>
        <small className="mt-[18px] block font-(family-name:--eg-font-ui) text-[11.5px] text-eg-text-muted">
          Registrazione gratuita &middot; Verifica P.IVA &middot; Credito solo quando vuoi
        </small>
      </section>

      <footer className="relative z-[2] flex justify-between gap-6 border-t border-eg-border px-12 py-[34px] font-(family-name:--eg-font-ui) text-[11.5px] uppercase tracking-[0.08em] text-eg-text-muted max-[860px]:flex-col max-[860px]:px-[22px]">
