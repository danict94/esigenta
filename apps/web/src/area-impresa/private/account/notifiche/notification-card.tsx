...
function MetaItem({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 text-eg-text-muted">
      <span className="text-eg-text-muted/70">{icon}</span>
      {children}
    </span>
  )
}
  ...
  return (
    <Card
      className={cn(
        ...
        unread
          ? "border-eg-brand-strong shadow-eg-elevation-lg"
          : "border-eg-border",
      )}
    >
      <CardHeader className="border-b border-eg-border">
          ...
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              {unread ? (
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full bg-eg-brand-strong px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-eg-on-brand">
                  <span className="h-1.5 w-1.5 rounded-full bg-eg-on-brand" />
                  Nuova
                </span>
              ) : null}
              ...
              {notification.type === "CONVERSATION_MESSAGE" ? (
                <span className="inline-flex items-center gap-1.5 rounded-full bg-eg-brand-soft px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-eg-brand-strong">
                  Messaggio
                </span>
              ) : null}
            </div>
      ...
      <CardContent className="space-y-4 pt-6">
        ...
        {request ? (
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-eg-border pt-4 text-sm">
