        ...
        <div className="px-7 py-5 text-center">
          {hasNextPage ? (
            <button
              ...
              disabled={isPending}
              className="rounded-full border border-eg-border bg-eg-surface px-5 py-2 font-(family-name:--eg-font-ui) text-[11px] uppercase tracking-[0.06em] text-eg-ink transition-colors hover:border-eg-brand disabled:cursor-not-allowed disabled:opacity-60"
            >
