        ...
        <div className="px-7 py-5 text-center">
          {hasNextPage ? (
            <button
              ...
              disabled={isPending}
              className="rounded-full border border-eg-hairline bg-eg-calce px-5 py-2 font-mono text-[11px] uppercase tracking-[0.06em] text-eg-terra transition-colors hover:border-eg-terra disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isPending ? "Caricamento..." : "Carica altre richieste"}
            </button>
          ) : (
            <p className="font-mono text-[11px] text-eg-ardesia-2">
