                ...
                <ul className="mt-[54px] border-t border-eg-border max-[860px]:mt-[38px]">
                  {result.requests.map((request, index) => (
                    <li key={request.requestId}>
                      ...
                      >
                        <span className="font-(family-name:--eg-font-primary) text-xs font-semibold text-eg-brand-strong [font-variant-numeric:tabular-nums]">
                        ...
                        <span className="justify-self-end whitespace-nowrap font-(family-name:--eg-font-primary) text-[12px] font-medium text-eg-text-muted max-[860px]:col-start-2 max-[860px]:mt-1 max-[860px]:justify-self-start">
