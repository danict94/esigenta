import { Button, Card, CardContent, Container, Input, cn } from "@esigenta/ui";
        ...
        <Container size="lg">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(22rem,29rem)] lg:items-center lg:gap-16">
            <div className="mx-auto flex w-full max-w-xl flex-col gap-5 text-center lg:mx-0 lg:text-left">
              ...
              <h1 className="text-3xl font-semibold leading-tight tracking-tight text-cantiere-ink sm:text-4xl md:text-5xl">
                Accedi al tuo
                <br />
                storico richieste
              </h1>

              <p className="mx-auto max-w-xl text-base leading-7 text-cantiere-ink-secondary md:text-lg md:leading-8 lg:mx-0">
            ...
            <Card className="mx-auto w-full max-w-md">
              <CardContent className="flex flex-col gap-6 p-6 pt-6 md:p-8">
                <div className="flex flex-col gap-2">
                  <h2 className="text-xl font-semibold tracking-tight text-cantiere-ink md:text-2xl">
                ...
                {hasSent ? (
                  <div
                    className={cn(
                      "border border-cantiere-hairline bg-cantiere-linen px-4 py-3 text-sm leading-6 text-cantiere-ink-secondary",
                      "rounded-[8px]",
                    )}
                  >
                    <strong className="font-semibold text-cantiere-ink">
                ...
                <p className="text-center text-sm leading-6 text-cantiere-ink-secondary">
