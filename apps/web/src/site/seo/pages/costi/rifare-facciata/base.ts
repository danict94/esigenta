...
// market-data/pricing/guides/rifare-facciata.ts per il dettaglio completo delle 14
...
export const rifareFacciataBase: CostGuideBaseContent = {
  ...
  // engine/editorial-date.ts): la guida passa da 6 righe (1 prezzata +
  ...
  scenarioExclusions: { title: "Nel rifacimento esteso non sono compresi", items: ["ponteggio", "cappotto termico"] },
  extrasPresentation: { title: "Cosa può far salire il prezzo", intro: "Alcune lavorazioni si aggiungono solo quando richieste dalle condizioni del supporto e non vanno considerate automaticamente." },
  factors: [
  ...
  // esplicitamente per questa guida).
  relatedWork: [
    {
