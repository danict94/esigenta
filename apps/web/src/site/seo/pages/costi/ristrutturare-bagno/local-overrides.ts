...
export const ristrutturareBagnoLocalOverrides: readonly CityLocalOverride[] = [
  {
    ...
    summary:
      "A Milano il riferimento prudente resta da 4.500 € a 8.000 €, con costo al mq indicativo da 800 € a 1.200 €. La stima può salire quando il bagno è in condominio, ai piani alti o in immobili con accesso complesso.",
    localReading:
  ...
  },
  {
    ...
    summary:
      "A Roma la fascia indicativa resta da 4.500 € a 8.000 €, con riferimento al mq da 800 € a 1.200 €. Il costo può cambiare molto tra centro storico, palazzi datati, zone condominiali e abitazioni più recenti.",
    localReading:
  ...
  },
  {
    ...
    summary:
      "A Torino si può usare il range nazionale da 4.500 € a 8.000 € e il costo al mq indicativo da 800 € a 1.200 €. La stima dipende da dimensione del bagno, età degli impianti e tipo di intervento.",
    localReading:
  ...
  },
  {
    ...
    summary:
      "A Napoli il riferimento resta da 4.500 € a 8.000 €, con costo al mq indicativo da 800 € a 1.200 €. Accessibilità, piano dell'immobile e gestione dei materiali possono incidere sulla stima finale.",
    localReading:
  ...
  },
  {
    ...
    summary:
      "A Bologna la fascia da 4.500 € a 8.000 € resta un riferimento prudente, insieme al costo al mq da 800 € a 1.200 €. Il preventivo cambia in base a edificio, metratura e livello di finitura.",
    localReading:
    ...
    faq: [
      {
        question:
          "A Bologna è meglio chiedere un preventivo a corpo o a voci?",
        answer:
  ...
  },
  {
    ...
    summary:
      "A Firenze il range nazionale da 4.500 € a 8.000 € e il costo al mq da 800 € a 1.200 € vanno letti considerando accessi, contesto dell'immobile e possibili complessità di cantiere.",
    localReading:
  ...
  },
  {
    ...
    summary:
      "A Palermo si può usare la fascia nazionale da 4.500 € a 8.000 € e il costo al mq da 800 € a 1.200 € come base, adattandoli allo stato dell'impianto e alle opere richieste.",
    localReading:
  ...
  },
  {
    ...
    summary:
      "A Catania la fascia nazionale da 4.500 € a 8.000 € e il riferimento al mq da 800 € a 1.200 € restano la base, da confermare in base a immobile, impianti e materiali.",
    localReading:
    ...
    faq: [
      {
        question:
          "A Catania il prezzo cambia tra appartamento e casa indipendente?",
        answer:
