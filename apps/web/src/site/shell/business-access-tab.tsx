    ...
    >
      <div className="relative">
        <Link
          ...
          className="eg-action-link flex flex-col items-center gap-1 rounded-l-eg-lg border border-r-0 border-eg-border bg-eg-surface px-3 py-2.5 text-center text-eg-brand-strong shadow-eg-elevation transition-colors hover:text-eg-brand-hover"
        >
        ...
        <button
          ...
          className="absolute -left-2 -top-2 flex size-8 items-center justify-center rounded-full border border-eg-border bg-eg-surface text-eg-text-muted shadow-eg-elevation transition-colors hover:text-eg-brand-hover"
        >
