 ...
 * stesso catalogo frozen che genera le route). Niente /richiesta/*, aree private,
 ...
 * "/servizi", "/professionisti" e "/professionisti/[slug]" non hanno oggi una fonte editoriale
...
export default function sitemap(): MetadataRoute.Sitemap {
  const professionSlugs = listPublicProfessionCategorySlugs();
